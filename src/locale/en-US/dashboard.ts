export default {
  ...
  'dashboard.perses.skill.desc':
    'Install the perses-dashboard skill so your AI coding agent can generate Perses dashboard or panel JSON from SQL, PromQL, or natural language.',
  ...
  'dashboard.perses.skill.installLinkText': 'Install',
