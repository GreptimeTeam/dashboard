export default {
  ...
  'metrics.sidebar.countShown': '{count} metrics',
  'metrics.sidebar.countShownCapped': '{count}+ metrics',
  ...
  'tables.sidebar.logicalTableLabel': 'Logical table',
  'tables.sidebar.physicalTableLabel': 'Physical table',
  'tables.sidebar.logicalTableTooltip': '{name} · Logical table (virtual); data is stored in physical table {physical}',
  'tables.sidebar.physicalTableTooltip': '{name} · Physical table that stores data of related logical tables',
  'dashboard.run': 'Run',
