export default {
  ...
  'dashboard.perses.skill.desc':
    '安装 perses-dashboard skill 后，你的 AI 编程助手可用 SQL、PromQL 或自然语言生成 Perses 仪表盘或 Panel JSON。',
  'dashboard.perses.skill.installLabel': '安装',
  'dashboard.perses.skill.installCommand': 'npx skills add GreptimeTeam/dashboard -s perses-dashboard',
  'dashboard.perses.skill.installUrl': 'https://github.com/GreptimeTeam/dashboard/blob/main/skills/README.md',
  'dashboard.perses.skill.installLinkText': '安装',
  'dashboard.perses.skill.showEntry': 'Agent Skill 安装说明',
