export default {
  ...
  'metrics.sidebar.countShown': '{count} 个 metrics',
  'metrics.sidebar.countShownCapped': '{count}+ 个 metrics',
  'metrics.sidebar.countMatches': '{count} 个匹配',
  'metrics.sidebar.countMatchesCapped': '{count}+ 个匹配',
  ...
  'tables.sidebar.logicalTableLabel': '逻辑表',
  'tables.sidebar.physicalTableLabel': '物理表',
  'tables.sidebar.logicalTableTooltip': '{name} · 逻辑表（虚拟表），数据存储于物理表 {physical}',
  'tables.sidebar.physicalTableTooltip': '{name} · 物理表，存储关联逻辑表的数据',
  'dashboard.run': '查询',
