...
export function getSqlResult() {
  ...
  return {
    output: {
      records: {
        rows: [
          ['host1', 1660897955, 66.6, 1024.0, 100],
          ['host2', 1660897956, 77.7, 2048.0, 103],
          ['host1', 1660897957, 63.6, 1024.0, 103],
          ['host1', 1660897958, 66.6, 1024.0, 103],
          ['host1', 1660897959, 90.6, 2000.0, 103],
          ['host1', 1660897960, 80.6, 1000.0, 103],
          ['host1', 1660897961, 66.6, 1024.0, 103],
        ],
        schema: {
          column_schemas: [
            {
