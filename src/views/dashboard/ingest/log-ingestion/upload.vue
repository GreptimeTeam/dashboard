...
<script lang="ts" setup name="LogIngestionUpload">
  import { ref, computed } from 'vue'
  import { Codemirror as CodeMirror } from 'vue-codemirror'
  import { basicSetup } from 'codemirror'
  import type { Log } from '@/store/modules/log/types'
  import useLog from '@/hooks/log'
  import useIngestStore from '@/store/modules/ingest'
  ...
  onActivated(() => {
    activeTab.value = 'log-ingestion-upload'
  })
  ...
  const submit = async (pipeline: string) => {
